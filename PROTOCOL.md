# E87 / L8 Smart Badge — BLE Protocol Reference

> Full reverse-engineering of the Jieli RCSP BLE protocol used by the E87 / L8 round LED badge.
> Derived from Apple PacketLogger captures and Zrun APK decompilation.
>
> For the web app and user-facing documentation, see the main [README](./README.md).
